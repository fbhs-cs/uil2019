...
public class HikingChallenge {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (in.hasNextLine()) {
            ...
            Node start = grid[Integer.parseInt(first.substring(2, first.indexOf(",")))][Integer.parseInt(first.substring(first.indexOf(",")+1, first.indexOf(")")))];
            ...
            do {
                ...
                for(Node neighbor : current.neighbors) {
                    ...
                    neighbor.g = tempG;
                    neighbor.f = neighbor.g + heuristic(neighbor, end) + neighbor.h;
                }
            }while(current != end);
